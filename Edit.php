...
class Widget_Metas_Category_Edit extends Widget_Abstract_Metas implements Widget_Interface_Do
{
    ...
    public function form($action = NULL)
    {
        ...
        /** 分类icon */
        $iconfont =  new Typecho_Widget_Helper_Form_Element_Text('iconfont', NULL, NULL,
        _t('分类icon'), _t('此文字用于描述分类iconfont, 在有的主题中它会被显示<br><img src="https://s1.ax1x.com/2023/03/02/ppFByJU.png" width="100%" height="auto" />.'));
    ...
    public function insertCategory()
    {
        ...
        /** 取出数据 */
        $category = $this->request->from('name', 'slug','iconfont','description', 'parent');

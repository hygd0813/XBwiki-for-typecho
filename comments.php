...
<?php echo preg_replace('#\@\((.*?)\)#', '<img src="https://wiki.80srz.com/usr/themes/XBwiki/img/smiles/$1.png">', $comments->content); ?>
</div>
...
<textarea name="text" id="textarea" class="textarea" placeholder="嘿！是不是说点什么……" required ><?php $this->remember('text'); ?></textarea>
</p>
